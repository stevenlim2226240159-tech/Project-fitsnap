    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snap) {
          ...
          if (docs.isEmpty) return const Center(child: Text('Belum ada followers'));
              ...
              return FutureBuilder<DocumentSnapshot>(
                ...
                builder: (context, userSnap) {
                  ...
                  return ListTile(
                    ...
                    trailing: Builder(builder: (context) {
                      ...
                      return StreamBuilder<DocumentSnapshot>(
                        ...
                        builder: (context, followSnap) {
                            ...
                            return ElevatedButton(
                              onPressed: _processingId
                                  ...
                                  : () async {
                                      ...
                                      if (confirm == true) {
                                        await _unfollowUser(followerId);
                                      }
                                    },
                          ...
                          return ElevatedButton(
                            onPressed: _processingId ? null : () => _followUser(followerId),
                    ...
                    onTap: () {
                      Navigator.of(context).push(MaterialPageRoute(builder: (_) => UserProfileScreen(userId: followerId)));
                    },
                  );
                },
              );
